...
RELU_VR="$RELU_VR;/layer1/layer1.0/relu/Relu=3"    #  2
RELU_VR="$RELU_VR;/layer1/layer1.0/relu_1/Relu=5"    #  3
RELU_VR="$RELU_VR;/layer1/layer1.1/relu/Relu=3"    #  4
...
RELU_VR="$RELU_VR;/layer1/layer1.3/relu_1/Relu=5"    #  9
RELU_VR="$RELU_VR;/layer1/layer1.4/relu/Relu=3"    #  10
RELU_VR="$RELU_VR;/layer1/layer1.4/relu_1/Relu=5"    #  11
RELU_VR="$RELU_VR;/layer2/layer2.0/relu/Relu=3"    #  12
RELU_VR="$RELU_VR;/layer2/layer2.0/relu_1/Relu=5"    #  13
RELU_VR="$RELU_VR;/layer2/layer2.1/relu_1/Relu=5"    #  15
RELU_VR="$RELU_VR;/layer2/layer2.2/relu_1/Relu=5"    #  17
RELU_VR="$RELU_VR;/layer2/layer2.3/relu_1/Relu=6"    #  19
RELU_VR="$RELU_VR;/layer2/layer2.4/relu_1/Relu=6"    #  21
RELU_VR="$RELU_VR;/layer3/layer3.0/relu/Relu=3"    #  22
RELU_VR="$RELU_VR;/layer3/layer3.0/relu_1/Relu=5"    #  23
RELU_VR="$RELU_VR;/layer3/layer3.1/relu_1/Relu=4"    #  25
RELU_VR="$RELU_VR;/layer3/layer3.2/relu/Relu=3"    #  26
RELU_VR="$RELU_VR;/layer3/layer3.2/relu_1/Relu=6"    #  27
RELU_VR="$RELU_VR;/layer3/layer3.3/relu/Relu=4"    #  28
RELU_VR="$RELU_VR;/layer3/layer3.3/relu_1/Relu=10"    #  29
RELU_VR="$RELU_VR;/layer3/layer3.4/relu_1/Relu=11"    #  31
